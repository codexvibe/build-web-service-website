export const translations = {
  fr: {
    ...
    order: {
      ...
      success_desc: "Votre demande a bien été reçue. Nous vous contacterons très prochainement.",
      new_request: "Nouvelle demande",
      section_contact: "Coordonnées",
      section_need: "Votre Besoin",
    ...
    footer: {
      ...
      serv_vitrine: "Site Vitrine",
      serv_ecommerce: "E-commerce",
      serv_apps: "App Web / SaaS",
    },
    theme: {
      light: "Mode Clair",
      dark: "Mode Sombre",
  ...
  en: {
    ...
    order: {
      ...
      success_title: "Request Saved.",
      success_desc: "Your request has been received. We will contact you very soon.",
      new_request: "New request",
      section_contact: "Contact Info",
      section_need: "Your Need",
    ...
    footer: {
      ...
      serv_vitrine: "Showcase Sites",
      serv_ecommerce: "E-commerce",
      serv_apps: "Web App / SaaS",
    },
    theme: {
      light: "Light Mode",
      dark: "Dark Mode",
  ...
  ar: {
    ...
    order: {
      ...
      success_title: "تم تسجيل الطلب.",
      success_desc: "لقد تم استلام طلبك بنجاح. سنتصل بك في أقرب وقت ممكن.",
      new_request: "طلب جديد",
      section_contact: "معلومات الاتصال",
      section_need: "احتياجك",
    ...
    footer: {
      ...
      serv_vitrine: "موقع تعريفي",
      serv_ecommerce: "متجر إلكتروني",
      serv_apps: "تطبيق ويب / SaaS",
    },
    theme: {
      light: "الوضع المضيء",
      dark: "الوضع المظلم",
